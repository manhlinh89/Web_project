...
var values = [];
var imgList = new List('list-user-img', options);//dung thư viện listJS: https://listjs.com/examples/existing-list-add/
...
//Khi click vào ảnh trong phần modal thì sẽ thay đôi disable hay enable button chọn ảnh hay xoá ảnh
...
//call api upload ảnh lên server
...
$('.btn-delete-img').click(function() {
	...
	// Confirm
	let click = confirm("Bạn chắc chắn muốn xóa ảnh này khôngfffff?");
	if (click == true) {
		// Send api delete
		$.ajax({
